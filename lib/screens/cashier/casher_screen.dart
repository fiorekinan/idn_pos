...
class _CashierScreenState extends State<CashierScreen> {
  ...
  void _showQRModal(String qrdata, int total, bool isPrinting){
    showModalBottomSheet(
      ...
      builder: (context) => QrResultModal(
        ...
        onClose: () => Navigator.pop(context) //ibaratnya kayak ambil 1 buku di paling atas biar buku lain dibawahnya keliatan,
      )
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // drop down SELECT PRINTER
          PrinterSelector(
            devices: _devices,
            selectedDevices: _selesctedDevice,
            ...
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                itemBuilder: (context, index) {
                  ...
                  //pemanggilan list pada product card
                  return ProductCard(
                    product: product,
                    qty: qty,
